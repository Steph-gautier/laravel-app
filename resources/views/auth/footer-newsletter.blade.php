<footer class="footer-all">
  <svg id="footer-svg" style="z-index:0;position:absolute;height:400px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
  ...
  <div class="row footer-core">
      <div class="col-lg-3 col-sm-3 mix-footer" style="text-align:center">
      ...
      <div class="col-lg-6 col-sm-6 mix-footer" id="sub-btn" style="text-align:center">
                  <h4>Keep me updated!</h4>
                  <form method="post" action="{{url('newsletter')}}">
                  <div class="input-group">
                  {{csrf_field()}}
                      <input type="email" name="email" class="form-control in-custom" style="border-top-left-radius: 25px;border-bottom-left-radius: 25px;" placeholder="Your email address please..." aria-label="Your email address please...">
      ...
      <div class="col-lg-3 col-sm-3 mix mix-footer">
